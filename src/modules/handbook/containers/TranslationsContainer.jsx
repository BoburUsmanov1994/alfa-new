  ...
  const ModalBody = ({ data, rowId = null }) => (
    <>
      <Field
        ...
        type={"input"}
        label={"Key"}
        defaultValue={rowId ? get(data, "key") : null}
      ...
      <Field
        ...
        type={"input"}
        label={"Uz"}
        defaultValue={rowId ? get(data, "uz") : null}
        params={{ required: true }}
      />
      <Field
        name={"kr"}
        type={"input"}
        label={"Уз"}
        defaultValue={rowId ? get(data, "kr") : null}
        params={{ required: true }}
      />
      <Field
        name={"ru"}
        type={"input"}
        label={"Ru"}
        defaultValue={rowId ? get(data, "ru") : null}
        params={{ required: true }}
      />
      <Field
        name={"eng"}
        type={"input"}
        label={"En"}
        defaultValue={rowId ? get(data, "eng") : null}
        params={{ required: true }}
      />
    </>
  );
