...
let settingsStore = (set) => ({
    ...
    resetInsurer: () => set(state => ({...state, insurer: {type: PERSON_TYPE.person, openModal: false, data: null}})),
    resetBeneficiary: () => set(state => ({...state, beneficiary: {type: PERSON_TYPE.person, openModal: false, data: null}})),
    resetPledger: () => set(state => ({...state, pledger: {type: PERSON_TYPE.person, openModal: false, data: null}})),
